...
## Architecture 
![Pipeline Architecture](https://github.com/thotamohan/Populating-redshift-data-warehouse-for-user-analytics/blob/main/docs/images/architecture.png)
...
#### Overview
The data collected from the goodreads API is stored on local disk and is timely moved to the Landing Bucket on AWS S3. ETL jobs are written in spark and scheduled in airflow to run every 10 minutes.  
...
## DAG Tree view
![DAG Tree view](https://github.com/thotamohan/Populating-redshift-data-warehouse-for-user-analytics/blob/main/docs/images/DAG_tree_view.PNG)
